...
public class HomeController extends HomeComponentsController implements Serializable {
    ...
    private String strNoControl;
    

    public String getStrNoControl() {
        return strNoControl;
    }

    public void setStrNoControl(String strNoControl) {
        this.strNoControl = strNoControl;
    }
    
    public void buscarAlumno(ActionEvent aev){
        
        System.out.println("NoControl " + strNoControl);
        if(strNoControl != null){
            setAlumnoBuscado(alumnoFacade.find(strNoControl));
            if(getAlumnoBuscado() != null){
                setAlumnoSeleccionado(getAlumnoBuscado());
                System.out.println("No Control " + getAlumnoBuscado().getNoControl() + " Nombre " + getAlumnoBuscado().getNombre());
            }else{
                System.out.println("No se encontro el alumnos");
            }
        }
